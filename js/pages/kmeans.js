...
export function renderKMeans(container) {
  ...
  container.innerHTML = `
    ...
    <div class="page-header">
      ...
      <span class="lesson-number">Lesson 2 — Unsupervised Learning</span>
...
<span class="comment"># Fit to data</span>

kmeans.<span class="fn">fit</span>(X)



<span class="comment"># Get cluster labels</span>
...
centroids = kmeans.cluster_centers_</pre>
    ...
    <div class="steps-section">
      ...
      <div class="steps-header">
        ...
        <h3>K-Means Clustering — Step by Step</h3>

        <p>Understanding how the algorithm finds natural groups without any labels</p>
      ...
      <div class="steps-grid">
        ...
        <div class="step-card">
          ...
          <div class="step-title">What is Unsupervised Learning?</div>

          <div class="step-body">Unlike supervised learning, K-Means has <strong>no labels</strong>. It only sees features (coordinates) and discovers hidden structure by grouping similar points together — just like sorting colored marbles without being told the colors first.</div>

          <div class="step-formula">Input: Unlabeled points → Output: Cluster assignments</div>
        ...
        <div class="step-card">
          ...
          <div class="step-title">Initialize Centroids</div>

          <div class="step-body">Place <strong>K centroids</strong> at random positions in the data space. These are the initial "cluster centers" — they will move over time to better represent actual groups. K is a hyperparameter you choose before training.</div>

          <div class="step-formula">K random points → c₁, c₂, …, cₖ</div>
        ...
        <div class="step-card">
          ...
          <div class="step-title">Assign Each Point</div>

          <div class="step-body">For every data point, <strong>measure the distance</strong> to each centroid and assign the point to the nearest one. This creates K groups. The most common distance used is Euclidean (straight-line) distance.</div>

          <div class="step-formula">label(x) = argmin‖x − cₖ‖²</div>
        ...
        <div class="step-card">
          ...
          <div class="step-title">Move Centroids</div>

          <div class="step-body">Now <strong>recompute each centroid</strong> as the average position of all points assigned to it. The centroid shifts toward the true center of its cluster. You'll see them jump on the canvas at each step!</div>

          <div class="step-formula">cₖ = mean of all points in cluster k</div>
        ...
        <div class="step-card">
          ...
          <div class="step-body">Steps 3 and 4 repeat until the centroids <strong>stop moving</strong> (or move less than a tiny threshold). This is called <em>convergence</em>. The inertia (total distance from points to their centroids) falls at each step.</div>

          <div class="step-formula">Repeat while Îcentroids &gt; Îµ</div>
        ...
        <div class="step-card">
          ...
          <div class="step-title">Evaluate with Inertia</div>

          <div class="step-body"><strong>Inertia</strong> measures the total within-cluster sum of squared distances. Lower = tighter clusters. Try the <em>Elbow Method</em>: plot inertia vs K and look for the "elbow" where adding more clusters stops helping much.</div>

          <div class="step-formula">Inertia = Σâ Σ_{xâCâ} ‖x − cₖ‖²</div>
